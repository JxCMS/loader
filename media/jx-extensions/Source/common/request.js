 ...
 * 
 * This class will allow us to send and track multiple requests. It provides for common debug
 * handling, assigning unique request IDs (in a particular session), application wide common
 * error handling (while still allowing callers to handle problems not handled by the wider
 * application).
 * 
...
Jx.Request = new Class({
	...
	failure: function (instance, id) {
		...
		var opt = this.currentRequest.get('options');
